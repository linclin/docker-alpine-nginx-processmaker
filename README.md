...
sudo docker build  --network=host --no-cache -t  registry.cn-shenzhen.aliyuncs.com/dev-ops/processmaker .
sudo docker push registry.cn-shenzhen.aliyuncs.com/dev-ops/processmaker
