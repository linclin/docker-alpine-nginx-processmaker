...
RUN sed -i 's/dl-cdn.alpinelinux.org/mirrors.aliyun.com/g' /etc/apk/repositories \
    && apk update  \
    && apk add   bash curl curl-dev openldap-dev tzdata nginx ca-certificates php7-fpm php7-opcache php7-json php7-zlib php7-xml   php7-pdo php7-phar php7-openssl php7-pdo_mysql php7-mysqli php7-gd php7-iconv php7-mcrypt php7-ctype php7-cli php7-curl php7-soap php7-ldap php7-dom  freetds   \ 
